...
| Path                                    | Description                                                 |
| --------------------------------------- | ----------------------------------------------------------- |
| `@algorandfoundation/ac2-sdk/schema`    | Pure schema: types, type guards, decoding, and validation   |
| `@algorandfoundation/ac2-sdk/protocol`  | Message factories and dispatcher built on top of the schema |
| `@algorandfoundation/ac2-sdk/transport` | Liquid Auth transport integration                           |

## Usage

### `@algorandfoundation/ac2-sdk/schema`

Low-level schema primitives. Use this when you need direct control over decoding or validation.

```ts
import { decode, validate, isSigningRequest } from '@algorandfoundation/ac2-sdk/schema';
...
### `@algorandfoundation/ac2-sdk/protocol`
...
```ts
import { createSigningRequest } from '@algorandfoundation/ac2-sdk/protocol';
...
```ts
import { handleMessage } from '@algorandfoundation/ac2-sdk/protocol';
import type { MessageHandlers } from '@algorandfoundation/ac2-sdk/protocol';
...
### `@algorandfoundation/ac2-sdk/transport`
